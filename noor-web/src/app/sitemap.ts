...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes: Array<{
    ...
    { path: '/guides', changeFrequency: 'daily', priority: 0.97 },
    { path: '/hajj-umrah', changeFrequency: 'weekly', priority: 0.96 },
    { path: '/zakat', changeFrequency: 'daily', priority: 0.96 },
    ...
    { path: '/etiquette', changeFrequency: 'weekly', priority: 0.91 },
    { path: '/nikah', changeFrequency: 'weekly', priority: 0.91 },
